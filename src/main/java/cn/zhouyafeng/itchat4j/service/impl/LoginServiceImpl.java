...
public class LoginServiceImpl implements ILoginService {
  ...
  public boolean webWxInit() {
    ...
    try {
      ...
      // 1_661706053|2_661706420|3_661706415|1000_1494151022
      core.getLoginInfo().put(StorageLoginInfoEnum.synckey.getKey(), synckey.substring(0, synckey.length()
          - 1));// 1_656161336|2_656161626|3_656161313|11_656159955|13_656120033|201_1492273724|1000_1492265953|1001_1492250432|1004_1491805192
...
//						LOG.info(JSONObject.toJSONString(resultMap));
            ...
            if (retcode.equals(RetCodeEnum.UNKOWN.getCode())) {
              ...
              if (selector.equals("2")) {
                ...
                LOG.info(selector + "webWxSync result:" + webWxSync().toJSONString());
              ...
              LOG.info("webWxSync result:" + webWxSync().toJSONString());
            }
            retryCount = 0;
          } catch (Exception e) {
            LOG.info(e.getMessage());
        ...
        if ((o.getInteger("VerifyFlag") & 8) != 0) { // 公众号/服务号
          ...
          if (!core.getGroupIdList().contains(o.getString("UserName"))) {
            ...
            core.getGroupList().add(o);
						core.getGroupPropertyMap().put(o.getString("NickName"), o);
					}
    ...
    try {
      ...
      if (obj.getJSONObject("BaseResponse").getInteger("Ret") != 0) {
        ...
        core.getLoginInfo().put(StorageLoginInfoEnum.synckey.getKey(),
            synckey.substring(0, synckey.length()
                - 1));// 1_656161336|2_656161626|3_656161313|11_656159955|13_656120033|201_1492273724|1000_1492265953|1001_1492250432|1004_1491805192
      }
    } catch (Exception e) {
      LOG.info(e.getMessage());
